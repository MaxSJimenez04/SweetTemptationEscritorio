...
namespace sweet_temptation_clienteEscritorio.servicios
{
    internal class ProductoPedidoService
    {
        ...
        public async Task<(List<DetallesProductoDTO> productos, HttpStatusCode codigo, string mensaje)> obtenerProductosAsync(int idPedido)
        {
        ...
        public async Task<(ProductoPedidoDTO productoNuevo, HttpStatusCode codigo, string mensaje)> crearProductoAsync(int idProducto, int idPedido, int cantidad)
        {
        ...
        public async Task<(ProductoPedidoDTO productoActualizado, HttpStatusCode codigo, string mensaje)> actualizarProductoAsync( int idPedido,
            ProductoPedidoDTO productoActualizado)
        {
        ...
        public async Task<(HttpStatusCode codigo, string mensaje)> eliminarProductoAsync(int idPedido, int idProducto)
        {
        ...
        public async Task<(HttpStatusCode codigo, string mensaje)> comprarProductosAsync(int idPedido, List<DetallesProductoDTO> productoDTOs)
        {
